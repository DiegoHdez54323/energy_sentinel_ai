...
import { getHomeDashboard } from "./homes.dashboard.service.js";
...
export async function getHomeDashboardHandler(req: Request, res: Response) {
  try {
    const dashboard = await getHomeDashboard(getOwnedHomeOrThrow(req));
